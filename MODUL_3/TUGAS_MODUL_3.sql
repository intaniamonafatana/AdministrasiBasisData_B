...
--- Praktek 14
--- Mengambil nama_produk dari tabel penjualan yang nama produknya memiliki huruf 'f' sebagai awal kata
SELECT nama_produk 
FROM tr_penjualan 
...
--- Latihan Mandiri 4
--- Ambil nama_produk yang memiliki karakter kedua ‘a’ pada table tr_penjualn
SELECT nama_produk 
FROM tr_penjualan 
...
FROM ms_produk 
WHERE kategori_produk LIKE 't%' AND kategori_produk LIKE '%t%' > 2;
...
-- ambil semuah kolom pada tabel penjualan yg ketekorinya menggadung huruf t dan qty urut dari 3 bedasakan qty yang paling BESAR dan kecil
